...
namespace CRUDInternetshop
{
    ...
    class DataBaseCRUD
    {
        ...
        public DataBaseCRUD()
        {
...

            {
               //додаємо делегати на основні функції роботи з базою данних
                ...
                new ItemMenu(" Вибір таблиці", new GetMethod(Choice)), //додати користувача
                new ItemMenu(" Згенерувати", new GetMethod(AddRandom)), //додати користувача
        ...
        private void Choice()
        {
            string[] Male = { "Сергеевич", "Андреевич", "Петрович", "Данилович" };
            string[] Female = { "Сергеевна", "Андреевна", "Петровна", "Даниловна" };
            string[] text;
            var faker = new Faker("ru");


            if (faker.Person.Gender == Name.Gender.Male)
            {
            ...
            var user = new UserCreateModel()
            {
                ...
                Surname = faker.Person.Random.ArrayElement(text),
        ...
        private void AddUser(UserCreateModel user)
        {
            ...
            string strQuery = "INSERT INTO Users " +
               "(FirstName, LastName, Surname, Password, PasswordSolt, Email, Phone) " +
                $"VALUES('{user.FirstName}','{user.LastName}','{user.Surname}', " +
                $"'{user.Password}','{user.Password}','{user.Email}','{user.Phone}'); ";
